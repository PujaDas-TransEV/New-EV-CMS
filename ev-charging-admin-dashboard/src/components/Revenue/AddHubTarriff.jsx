...
//     price_type: 'Fixed',     // UI display value
...
//     }
//     if (formData.price_per_kwh === '' || formData.price_per_kwh === null || formData.price_per_kwh === undefined) {
...
//   const mapToApiValues = (displayValues) => {
//     return {
//       price_per_kwh: displayValues.price_per_kwh,
//       idle_fee_per_min: displayValues.idle_fee_per_min,
//       currency: displayValues.currency,
//       is_active: displayValues.is_active,
//       tariff_type: TARIFF_TYPE_MAP[displayValues.tariff_type] || 'fixed',
//       price_type: PRICE_TYPE_MAP[displayValues.price_type] || 'energy',
//       units: UNITS_MAP[displayValues.units] || 'watt/hour'
//     };
//   };

//   // Submit to CreateHubTariff API - matches backend CreateTariffRequest exactly
...
//     try {
//       const pricePerKWh = parseFloat(formData.price_per_kwh) || 0;
//       const idleFeePerMin = parseFloat(formData.idle_fee_per_min) || 0;
      
//       // Map UI display values to backend enum values
//       const apiPayload = {
//         price_per_kwh: Number(pricePerKWh.toFixed(4)),
//         idle_fee_per_min: Number(idleFeePerMin.toFixed(4)),
//         currency: formData.currency,
//         is_active: formData.is_active,
//         tariff_type: TARIFF_TYPE_MAP[formData.tariff_type] || 'fixed',
//         price_type: PRICE_TYPE_MAP[formData.price_type] || 'energy',
//         units: UNITS_MAP[formData.units] || 'watt/hour'
//       };

//       console.log('📤 UI Display Values:', {
//         tariff_type_display: formData.tariff_type,
//         price_type_display: formData.price_type,
//         units_display: formData.units
//       });
//       console.log('📤 Mapping to API Values:', {
//         tariff_type_api: apiPayload.tariff_type,
//         price_type_api: apiPayload.price_type,
//         units_api: apiPayload.units
//       });
...
//                   </p>
//                 )}
//                 <p className="mt-1 text-xs text-gray-400">Enter price per kWh (e.g., 18.50)</p>
//               </div>
...
//                   </div>
//                 </div>
//                 <p className="mt-1 text-xs text-gray-400">UI Label: {formData.units} → API: {UNITS_MAP[formData.units]}</p>
//               </div>
...
//                       <strong>Note:</strong> Hub is required. Charger, Customer Group, and GST are optional.
//                     </p>
//                     <p className="text-sm text-orange-700 mt-2">
...
//                       Units: {formData.units} → {UNITS_MAP[formData.units]}
//                     </p>
//                   </div>
//                 </div>
//               </div>
